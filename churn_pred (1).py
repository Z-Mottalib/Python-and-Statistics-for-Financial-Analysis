...
"""### Un rapide coup d'œil ci-dessus me fait réaliser que TotalCharges devrait être flottant mais c'est un objet. Vérifions ce qui se passe avec cette chronique
...
model = keras.Sequential([
    keras.layers.Dense(26, input_shape=(26,), activation='relu', kernel_regularizer=keras.regularizers.l2(0.01)),
    Dropout(0.5),
